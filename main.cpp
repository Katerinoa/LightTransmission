...
int FileToVideo(const char* filePath, const char* videoPath, int timLim = INT_MAX, int fps = 15)
{
	...
	fclose(fp);
	system("md outputImg");
	Code::Main(temp, size, "outputImg", "png", 1LL * fps * timLim / 1000); //编码 信息->图像
	FFMPEG::ImagetoVideo("outputImg", "png", videoPath, fps, 60, 100000); //视频 图像->视频
...
int main(int argc, char* argv[])
{
	...
	return FileToVideo("C:\\Users\\TingLans\\Desktop\\jnsj.jpg", "C:\\Users\\TingLans\\Desktop\\in.mp4", 3000);
